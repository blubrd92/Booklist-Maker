...
(function() {
  ...
  const CONFIG = {
    ...
    PLACEHOLDERS: {
      ...
      qrText: "Enter your blurb here. To link to an online list (like Bibliocommons), go to Settings > Back Cover and paste the URL in the 'QR Code URL' field and click Update. You can also click the QR code square to upload your own image. Remember to test the code with your phone!",
    },
