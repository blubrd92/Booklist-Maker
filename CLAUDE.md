...
- **Micro-reactions**: nod, perk, wince, watch (eye tracking), yawn, startle, satisfied, squish (tactile press-down on single click; nod remains the reaction for app-event triggers like star toggles), plus three idle fidgets (stretch, ear-flick, tail-swish)
