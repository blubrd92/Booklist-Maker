...
- **Tap-to-edit sheet** (`openBookEditSheet`, `#book-edit-modal`) predates this layout: on phones a tap on a title's text opens it instead of inline contenteditable editing.
